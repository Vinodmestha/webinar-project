            ...
            {loading ? (
                ...
                <div className="grid lg:grid-cols-3 grid-cols-1 gap-x-12 gap-y-8">
                    {whyUsData?.map((item, i) => (
                        <div
                            key={item?._id}
                            className={`p-3 flex flex-col items-center text-center rounded-lg transition-all duration-500 hover:scale-105 shadow-md bg-gray-100 border border-gray-300 ${
